...
const popupName = ref('')
// 点击地址或服务打开弹窗
const onPopupTap = (type: 'service' | 'address') => {
...
<template>
  <scroll-view scroll-y class="viewport">
      ...
      <view class="preview">
        <swiper circular @change="swiperChange">
          <swiper-item v-for="item in goodsList?.mainPictures" :key="item">
            <image @tap="onPreviewImage(item)" mode="aspectFill" :src="item" />
          </swiper-item>
        </swiper>
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties" v-for="item in goodsList?.details.properties" :key="item.name">
          <!-- 属性详情 -->
          <view class="item">
